...
public class Array05 {
	...
	public static void main(String[] args) {
		...
		//ceviren java kodu yazalim otuzocakikibin
		...
		System.out.println("30.01.2000 formatinda tarih giriniz");
		...
		String [] yüzler = {"","yuz", "ikiyuz", "ucyuz", "dortyuz", "besyuz", "altiyuz", "yediyuz","sekizyuz", "dokuzyuz"};
		String [] binler = {"","bin", "ikibin", "ucbin", "dortbin", "besbin", "altibin", "yedibin","sekizbin", "dokuzbin"};
		
		System.out.println("Girilen tarihin yazi ile yazilmasi: "+onlar[on] + birler[bir]+" " +aylar[ay]+" " + binler[yilbinler]+ yüzler[yilyüzler]+
